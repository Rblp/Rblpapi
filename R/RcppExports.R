...
getBars_Impl <- function(con, security, eventType, barInterval, startDateTime, endDateTime, options_, verbose = FALSE) {
    .Call('Rblpapi_getBars_Impl', PACKAGE = 'Rblpapi', con, security, eventType, barInterval, startDateTime, endDateTime, options_, verbose)
}
