...
bdh <- function(conn_, securities, fields, start_date_, end_date_, options_, identity_) {
    .Call('Rblpapi_bdh', PACKAGE = 'Rblpapi', conn_, securities, fields, start_date_, end_date_, options_, identity_)
}

bdp <- function(conn_, securities, fields, options_, identity_) {
    .Call('Rblpapi_bdp', PACKAGE = 'Rblpapi', conn_, securities, fields, options_, identity_)
}
